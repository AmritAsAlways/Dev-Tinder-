...
authRouter.post("/signup", async (req, res) => {
  ...
  try {
    ...
    const savedUser=await user.save(); //method used to save data to database
    const jwttokenhaibhai= await savedUser.getJWT();
    res.cookie("tokenwallacookie", jwttokenhaibhai);
